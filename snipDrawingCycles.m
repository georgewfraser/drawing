function cyclesByDate = snipDrawingCycles(drawingByDate)
cyclesByDate = cell(size(drawingByDate));
for day=1:length(drawingByDate)
    drawing = drawingByDate{day};
    badtrials = [];
